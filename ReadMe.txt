...
Firstly, install python and pyautogui... you can search in youtube on how to install that

create a text file which contains the code, enter the path of text file in "Code Solver.py"( I have mentioned where to insert ). for example:"C:/Users/anonymous/Desktop/skillrack_code.txt"
